...
<?php
	...
	$sql1 = "SELECT Id,FirstName,Surname,HomePhone,MobilePhone,LastSeenDate,DOB,ChartOrNHS,Age,Inactive FROM Patient WHERE Postcode LIKE '%2880%' AND (CultureCode = 1 OR CultureCode = 2) AND Id NOT IN (".implode(',', $PTID).")";
	//echo $sql1;
