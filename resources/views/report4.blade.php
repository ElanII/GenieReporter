...
<html>
<head>
	@include('partials.header',['title'=>"3 - 5 YO HA"])
</head>
<body>
...
<?php
	...
	$sql0 = "SELECT PT_Id_Fk FROM Sale WHERE ItemNum IN ('701','703','705','707','715','10986') AND ServiceDate > :YearAgo";
	try {
	...
	$sql1 = "SELECT Id,FirstName,Surname,HomePhone,MobilePhone,LastSeenDate,DOB,ChartOrNHS,Age,Inactive FROM Patient WHERE Postcode LIKE '%2880%' AND Age >= 3 AND Age <= 5 AND Id NOT IN (".implode(',', $PTID).")";
	//echo $sql1;
	...
	$results_array = $stmt->fetchAll();
		...
		echo '<div class="panel-heading"><b>'.'3 - 5 Year Olds Health Assessments'.'</b></div>';
?>
