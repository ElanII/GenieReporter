...
<body>
	...
	<?php
		...
		$sql1 = "SELECT Id,FirstName,Surname,HomePhone,MobilePhone,LastSeenDate,DOB,ChartOrNHS,Age,Inactive FROM Patient WHERE Age >= 45 AND Age <= 49 AND
	...
	{{-- Table Section --}}
	@include('newpartials/table',['title'=>"Search Results for Appointments..."])
	<?php 
