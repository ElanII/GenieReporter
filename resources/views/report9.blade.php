...
<html>
<head>
	@include('partials.header',['title'=>"Hypertension No CP"])
</head>
<body>
...
<?php
	...
	$sql0 = "SELECT PT_Id_Fk FROM Sale WHERE ItemNum IN ('11700') AND ServiceDate >= :YearAgo";
	try {
	...
	$results_array = $stmt->fetchAll();
		...
		echo '<div class="panel-heading"><b>'.'Chronic Condition with No Care Plan in the last 12months (Hypertension)'.'</b></div>';
