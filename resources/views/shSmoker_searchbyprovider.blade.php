...
<html>
<head>
	@include('newpartials/head',['title'=>"Smokers Without CP by Appt"])
...
<body>
	...
	<div class="well well-lg">
		<div class="panel panel-default">
			<div class="panel-heading">Search for Smokers without CP by Appts</div>
			<div class="panel-body">
				<div class="form-group">
				{{ Form::open(array('route' => 'shSmoker_Results'.$clinic)) }}
