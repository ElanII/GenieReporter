...
<html>
<head>
	@include('partials.header',['title'=>"Past History Documentation"])
...
<?php
	...
	// Has Past History
	$sql2 = "SELECT DISTINCT PT_Id_Fk AS ID FROM PastHistory"; 
...
<body>
	...
	<div id="printThis" class="well-lg" style="margin:10;">
		<div style="font-family: 'Raleway', sans-serif;
			...
			Genie Reporter - Past History Information Stats.
		</div>
				...
				<div class="col-lg-6">
					<div class="panel-primary panel">
						...
						<div class="panel-body">
							<li class="list-group-item"><b>RACGP minimum requirement:</b> 75% of patients must have their Past History information on record</li>
							<li class="list-group-item"><b>Genie Record Keeping</b>
								<ul>
									<li>Past History: Small window in the clinical view towards the top middle must have at least one entry in it</li>
								</ul>
							</li>
						</div>
					</div>
		...
		<div class="panel-info table-responsive">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					...
					<tr>
						<td>Past History is NOT Empty and Active</td>
