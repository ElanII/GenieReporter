...
<html>
<head>
	@include('newpartials/head',['title'=>"High BMI Without CP by Appt"])
...
<body>
	...
	<div class="well well-lg">
		<div class="panel panel-default">
			<div class="panel-heading">Search for High BMI (>25) without CP by Appts</div>
			<div class="panel-body">
				<div class="form-group">
				{{ Form::open(array('route' => 'shBMI_Results'.$clinic)) }}
