				...
				<div class="col-lg-6">
					<div class="panel-primary panel">
						...
						<div class="panel-body">
							<li class="list-group-item"><b>RACGP minimum requirement:</b> 75% of patients must have a Current Problem on record</li>
							<li class="list-group-item"><b>Genie Record Keeping</b>
								<ul>
									<li>Current Problems: Small window located towards the top middle of the clinical view</li>
									<li>Must have at least "No problem" recorded</li>
								</ul>
							</li>
						</div>
					</div>
