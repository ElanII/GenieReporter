...
<html>
<head>
	@include('partials.header',['title'=>"Vaccination Documentation"])
...
<?php
	...
	// Has Vaccination
	$sql2 = "SELECT DISTINCT PT_Id_Fk AS ID FROM Vaccination"; 
	...
	<div id="printThis" class="well-lg" style="margin:10;">
		...
		<div class="panel-info table-responsive">
			<table class="table table-striped table-bordered">
				...
				<tbody>
					<tr>
						<td>Nothing Recorded OR Not Vaccinated</td>
						<td>{{$ptsWithout}}</td>
						<td>{{$ptsWithout / $activePatients * 100}} %</td>
					</tr>
					<tr>
						<td>Vaccination recorded and Active</td>
